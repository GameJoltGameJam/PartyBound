...
public class DrewDialogueScript : MonoBehaviour 
{
	private DrewDialogueScript Instance;
	private DrewPlayer player;
	private GameObject playerObject;
	public  GameObject npc1O;
	private DrewNPC1 npc1;
	...
	void Start () 
	{
		...
		player = playerObject.GetComponent<DrewPlayer>();
		start = end = current = 0;
	...
	public void StartDialogue(string name)
	{
		...
		case "NPC1":
		{
			...
			{
				print ("calling");
				npc1 = npc1O.GetComponent<DrewNPC1>();
				npc1.GetMission();
